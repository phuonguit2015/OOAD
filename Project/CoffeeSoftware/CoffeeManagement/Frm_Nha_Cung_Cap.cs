...
namespace CoffeeManagement
{
    public partial class Frm_Nha_Cung_Cap : Form
    {
        ...
        {
            dt = Utils.Util.ConvertToDataTable<NHA_CUNG_CAP>(_NhaCungCapBLL.LayDanhSachNhaCungCap());
        ...
        private void Frm_Nha_Cung_Cap_Load(object sender, System.EventArgs e)
        {
            LoadDataSource();
        }
        ...
        {
            Frm_Them_Nha_Cung_Cap f = new Frm_Them_Nha_Cung_Cap();
        ...
        private void btn_Xoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                int _ID_Nha_Cung_Cap = int.Parse(gridView1.GetRowCellValue(gridView1.GetSelectedRows()[i], "ID_Nha_Cung_Cap").ToString());
                _NhaCungCapBLL.XoaNhaCungCap(_ID_Nha_Cung_Cap);
            }
